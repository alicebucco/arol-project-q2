...
Non ci sono Dockerfile custom: `backend` e `frontend` girano da immagini ufficiali (`python:3.12-slim`, `node:20-alpine`) con il codice sorgente montato come bind mount — vedi [`docker-compose.yml`](docker-compose.yml).
